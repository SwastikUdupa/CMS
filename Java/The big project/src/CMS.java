...
public class CMS extends JFrame implements ActionListener {
	...
	public CMS(){
		...
		try {
			...
			String cString ="jdbc:ucanaccess://I:/CMSInfo.mdb";
	...
	private void initializeComponents() {
		...
		Icon delete= new ImageIcon("I:\\Pictures\\delete.gif");
		...
		Icon next= new ImageIcon("I:\\Pictures\\next.jpg");
		...
		Icon prev= new ImageIcon("I:\\Pictures\\previous.jpg");
		...
		Icon last= new ImageIcon("I:\\Pictures\\last.jpg");
		...
		Icon basic= new ImageIcon("I:\\Pictures\\basic.png");
		tabPane.addTab("Basic", basic, panelFields1);
		Icon address=new ImageIcon("I:\\Pictures\\address.jpg");
